...
import 'package:fe_lab_clinicas_self_service/src/modules/self_service/find_patient/find_patient_route.dart';
...
class SelfServiceModule extends FlutterGetItModule {
  ...
  Map<String, WidgetBuilder> get pages => {
        ...
        '/find-pacient': (context) => const FindPatientRoute(),
        '/pacient': (context) => const PatientRouter(),
